...
const options = [
	{
		img: 'https://d2pur3iezf4d1j.cloudfront.net/images/72529140fa35af37c56e0a20f1fbe2a8',
	},
	{
		img: 'https://d2pur3iezf4d1j.cloudfront.net/images/6fd84b8a838c43c4a84b44b08b10177e',
	},
	{
		img: 'https://d2pur3iezf4d1j.cloudfront.net/images/18a521f1507cb86689faa5b2e8277703',
	},
];
...
export default function Quiz() {
	...
	const handleCheckOrNext = () => {
		if (!checked) {
			...
			// Route to quiz2 when pressing Next
			router.push('/quiz2');
		}
	};
		...
		<div className="min-h-screen flex flex-col items-center bg-white pt-8 pb-4 px-2">
			...
			<div className="w-full max-w-xl mx-auto flex flex-col items-center">
				...
				<h2 className="text-2xl font-extrabold text-gray-800 mb-8 text-center">
					Which one is <span className="font-bold">"Coffee"</span>?
				</h2>
